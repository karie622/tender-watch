...
const AI_TYPES = {
  ...
  cbt: { title: "CBT 疗法", desc: "认知行为疗法视角拆解" }
};
const AI_PROMPTS = {
  ...
  cbt: "你是一位温和专业的 CBT（认知行为疗法）治疗师。请阅读以下记录，完成三步：1）识别其中的自动化思维（脑中一闪而过的念头）与认知扭曲（如灾难化、非黑即白、过度概括、读心术等，指出具体类型）；2）说明这些想法与情绪、行为之间的联结；3）给出温和的认知重构建议——换一种更平衡、更符合事实的说法。用中文回答，分点列出，语气温柔不说教。"
};
